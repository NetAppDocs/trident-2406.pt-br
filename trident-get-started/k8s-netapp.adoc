...
link: https://www.netapp.com/google-cloud/netapp-volumes/[NetApp Cloud Volumes Service para Google Cloud^] é um serviço de arquivos nativo da nuvem que fornece volumes NAS via NFS e SMB com desempenho all-flash. Este serviço permite que qualquer carga de trabalho, incluindo aplicativos legados, seja executada na nuvem do GCP. Ele oferece um serviço gerenciado que proporciona alto desempenho consistente, clonagem instantânea, proteção de dados e acesso seguro a instâncias do Google Compute Engine (GCE).
