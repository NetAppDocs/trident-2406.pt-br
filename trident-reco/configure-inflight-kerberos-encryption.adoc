...
.Antes de começar
* Certifique-se de que você habilitou o Astra Control Provisioner no cluster Red Hat OpenShift gerenciado. Consulte link:../trident-use/enable-acp.html["Habilite o Astra Control Provisioner"^] para obter instruções.
* Certifique-se de que tem acesso ao `tridentctl` utilitário.
