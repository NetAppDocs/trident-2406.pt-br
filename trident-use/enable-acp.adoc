...
Se você adicionar um cluster ao Astra Control Service que não tenha o Astra Trident instalado previamente, o cluster será marcado como  `Eligible`. Após adicionar o cluster ao Astra Control, o Astra Control Provisioner será ativado automaticamente.
...
. (Apenas para registros personalizados) Siga estas etapas para mover a imagem para o seu registro personalizado. Se você não estiver usando um registro, siga as etapas do operador Trident na <<first-step,próxima seção>>.
+
...
. [[primeiro passo]]Ative o Astra Control Provisioner no Astra Trident usando o método de instalação que você usou originalmente:
+
[role="tabbed-block"]
====
.Operador do Astra Trident
--
.. https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-operator.html#step-1-download-the-trident-installer-package["Baixe o instalador do Astra Trident e extraia-o."^].
...
.tridentctl
--
.. https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package["Baixe o instalador do Astra Trident e extraia-o."^].
